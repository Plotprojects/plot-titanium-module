...
#
#
import os, subprocess, sys, glob, string, optparse
import zipfile
...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.plotprojects.ti.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComPlotprojectsTiModuleAssets.m')
