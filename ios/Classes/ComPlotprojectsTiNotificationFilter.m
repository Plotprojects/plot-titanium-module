...
@implementation ComPlotprojectsTiNotificationFilter

-(void)startFilter {
    TiApp* app = [TiApp app];
    bridge = [[KrollBridge alloc] initWithHost:app];
    
    NSURL *fileURL = [TiUtils toURL:notificationFilterUrl relativeToURL:app.baseURL];
	NSURL *url = [TiUtils toURL:notificationFilterUrl relativeToURL:fileURL];
